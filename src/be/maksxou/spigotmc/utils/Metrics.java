...
public class Metrics {
    ...
    public Metrics(Plugin plugin, int pluginId) {
        ...
        if (!config.isSet("serverUuid")) {
            ...
            String header = "bStats collects some data for plugin authors like how many servers are using their plugins.\n" +
                    "To honor their work you should not disable it.\n" +
                    "This has nearly no effect on the server performance!\n" +
                    "Check out https://bStats.org/ to learn more :).";
            List<String> myList = new ArrayList<>(Arrays.asList(header.split("\\.")));

            // Inform the server owners about bStats
            config.options().setHeader(myList).copyDefaults(true);
            try {
